...
Spree::PermittedAttributes.user_attributes.push :first_name,:middle_name, :last_name, :second_last_name, :birth_day, :type_of_document, :document_id, :referred_code, :address, :neighborhood, :state, :city, :zipcode, :payment_method
